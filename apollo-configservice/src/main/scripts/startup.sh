...
export JAVA_OPTS="-server -Xms512m -Xmx1024m -Xss256k -XX:MetaspaceSize=128m -XX:MaxMetaspaceSize=384m
-XX:NewSize=512m -XX:MaxNewSize=1024m -XX:SurvivorRatio=18"
